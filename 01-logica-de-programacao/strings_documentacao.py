...
# ==========================================
# 9. IMUTABILIDADE NA PRÁTICA
# ==========================================

# Para "alterar" uma string, criamos uma nova

texto = "Python"
novo = "J" + texto[1:]  # 'Jython'
...
# - Use nomes claros
# - Evite concatenação excessiva (prefira f-strings)
# - Atenção com espaços e caracteres invisíveis
...
# Strings são fundamentais para manipulação de dados textuais
# Entender indexação e slicing é essencial
# Imutabilidade impacta diretamente na forma de trabalhar com texto
